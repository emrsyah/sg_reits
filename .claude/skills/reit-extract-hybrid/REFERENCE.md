...
| **Per-property cards** (occupancy/area/NPI/major_tenants; irregular) | ❌ deterministic; ✅ LLM lane | LLM lane — small targeted pass over the card pages, merged like the needs_llm pass |
